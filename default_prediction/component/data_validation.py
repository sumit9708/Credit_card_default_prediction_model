import os,sys
from default_prediction.entity.config_entity import DataValidationConfig
from default_prediction.entity.config_artifact import DataValidationArtifact,DataIngestionArtifact
    ...
    def is_train_test_file_exists(self)->bool:
        try:
            ...
            if not is_available:
                ...
                message = f"Training File : {training_file} and Test file : {test_file} is not available"
